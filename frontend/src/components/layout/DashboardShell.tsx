...
const NAV_MAIN = [
  ...
  { label: "Scores",    href: "/scores",    icon: BarChart2 },
...
const ALL_NAV = [...NAV_MAIN, ...NAV_SETTINGS]
    ...
    <div className="flex h-full flex-col bg-[#0d1526]">
      ...
      <div className="flex items-center gap-3 border-b border-white/[0.07] px-5 py-[18px]">
        ...
        <div className="leading-tight">
          ...
          <p className="text-[11px] text-slate-500">Identity Protection</p>
        </div>
      </div>

      {/* Nav */}
      <nav className="flex-1 space-y-5 overflow-y-auto px-3 py-5">
        <NavSection label="Monitor" items={NAV_MAIN} pathname={pathname} onNavigate={onNavigate} />
      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-14 shrink-0 items-center gap-4 border-b border-border bg-white px-6">
          ...
          <div className="flex items-center gap-2.5 md:hidden">
            ...
            <span className="text-sm font-bold">Zima</span>
          </div>

          {/* Desktop breadcrumb */}
          {currentPage && (
            <div className="hidden items-center gap-1.5 text-sm md:flex">
              <span className="font-medium text-muted-foreground">Zima</span>
