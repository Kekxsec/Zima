---
title: "prompt / ip / wigle"
aliases: ["wigle", "wigle prompt", "wigle research prompt"]
tags: [zima, research, prompts, provider-research, ip, wigle, graph_exclude]
...
- Target module(s) from my provider map: wifi_security
- Build priority / tier: 4 / Business
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): lookup(bssid)
  - likely provider-side category label(s): wifi_network
  - likely supported entity type(s): network
