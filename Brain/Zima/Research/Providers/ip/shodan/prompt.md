---
title: "prompt / ip / shodan"
aliases: ["shodan", "shodan prompt", "shodan research prompt"]
tags: [zima, research, prompts, provider-research, ip, shodan, graph_exclude]
...
- Provider name: shodan
- Provider category: ip
- Provider website / API docs URL: https://developer.shodan.io/api
- Target module(s) from my provider map: exposed_services, port_scanning, service_banner_analysis
- Build priority / tier: 3 / Pro
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): search_hosts(domain, ip)
  - likely provider-side category label(s): port_discovery, vulnerability, host_discovery
