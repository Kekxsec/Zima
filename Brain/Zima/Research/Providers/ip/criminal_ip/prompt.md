---
title: "prompt / ip / criminal_ip"
aliases: ["criminal_ip", "criminal_ip prompt", "criminal_ip research prompt"]
tags: [zima, research, prompts, provider-research, ip, criminal_ip, graph_exclude]
type: provider_research_prompt
provider: criminal_ip
...
- Provider name: criminal_ip
- Provider category: ip
- Provider website / API docs URL: unknown - please search
- Target module(s) from my provider map: exposed_services, domain_ioc_match
...
- Schema hints already captured in my notes:
  ...
  - likely provider-side category label(s): ip_reputation, port_discovery
