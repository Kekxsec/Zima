---
title: "prompt / ip / censys"
aliases: ["censys", "censys prompt", "censys research prompt"]
tags: [zima, research, prompts, provider-research, ip, censys, graph_exclude]
...
- Provider website / API docs URL: https://search.censys.io/api
- Target module(s) from my provider map: exposed_services, cve_correlation
...
- Schema hints already captured in my notes:
  ...
  - likely provider-side category label(s): host_discovery
