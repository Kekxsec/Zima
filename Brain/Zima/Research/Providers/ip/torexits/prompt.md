---
title: "prompt / ip / torexits"
aliases: ["torexits", "torexits prompt", "torexits research prompt"]
tags: [zima, research, prompts, provider-research, ip, torexits, graph_exclude]
...
- Provider name: torexits
- Provider category: ip
- Provider website / API docs URL: unknown - please search
- Target module(s) from my provider map: domain_reputation, account_enumeration_risk
...
- Schema hints already captured in my notes:
  ...
  - likely provider-side category label(s): tor_exit_node
