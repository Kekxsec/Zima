---
title: "prompt / threat_intel / urlscan"
aliases: ["urlscan", "urlscan prompt", "urlscan research prompt"]
tags: [zima, research, prompts, provider-research, threat_intel, urlscan, graph_exclude]
...
- Provider website / API docs URL: https://urlscan.io/docs/api/
- Target module(s) from my provider map: phishing_feed_monitor, domain_ioc_match
- Build priority / tier: 3 / Pro
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): scan(url, domain)
  - likely provider-side category label(s): malware_detection, phishing
