---
title: "prompt / threat_intel / stevenblack_hosts"
aliases: ["stevenblack_hosts", "stevenblack_hosts prompt", "stevenblack_hosts research prompt"]
tags: [zima, research, prompts, provider-research, threat_intel, stevenblack_hosts, graph_exclude]
type: provider_research_prompt
provider: stevenblack_hosts
...
- Provider name: stevenblack_hosts
- Provider category: threat_intel
- Provider website / API docs URL: unknown - please search
- Target module(s) from my provider map: phishing_feed_monitor
- Build priority / tier: 3 / Pro
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): check(domain, ip)
  - likely provider-side category label(s): blocklist_hit, threat_intel
