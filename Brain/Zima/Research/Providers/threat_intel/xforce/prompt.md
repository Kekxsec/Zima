---
title: "prompt / threat_intel / xforce"
aliases: ["xforce", "xforce prompt", "xforce research prompt"]
tags: [zima, research, prompts, provider-research, threat_intel, xforce, graph_exclude]
...
- Provider name: xforce
- Provider category: threat_intel
- Provider website / API docs URL: https://api.xforce.ibmcloud.com/doc/
...
- Schema hints already captured in my notes:
  - likely provider method(s): check(ip, domain, url)
