---
title: "prompt / threat_intel / koodous"
aliases: ["koodous", "koodous prompt", "koodous research prompt"]
tags: [zima, research, prompts, provider-research, threat_intel, koodous, graph_exclude]
...
- Provider name: koodous
- Provider category: threat_intel
- Provider website / API docs URL: https://koodous.com/apks
...
- Schema hints already captured in my notes:
  - likely provider method(s): check(hash)
