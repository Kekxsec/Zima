---
title: "prompt / threat_intel / openphish"
aliases: ["openphish", "openphish prompt", "openphish research prompt"]
tags: [zima, research, prompts, provider-research, threat_intel, openphish, graph_exclude]
...
- Provider name: openphish
- Provider category: threat_intel
- Provider website / API docs URL: https://openphish.com/phishing_feeds.html
...
- Schema hints already captured in my notes:
  - likely provider method(s): check(url, domain)
  - likely provider-side category label(s): phishing
  - likely supported entity type(s): url, domain
  - rough provider confidence note from my research scaffold: 0.85-0.95
