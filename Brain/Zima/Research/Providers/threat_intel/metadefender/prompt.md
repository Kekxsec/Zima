---
title: "prompt / threat_intel / metadefender"
aliases: ["metadefender", "metadefender prompt", "metadefender research prompt"]
tags: [zima, research, prompts, provider-research, threat_intel, metadefender, graph_exclude]
...
- Provider name: metadefender
- Provider category: threat_intel
- Provider website / API docs URL: https://onlinehelp.opswat.com/mdcorev5.9.1/docs/metadefender-core-api-reference
...
- Schema hints already captured in my notes:
  - likely provider method(s): scan(hash, ip)
  - likely provider-side category label(s): malware_detection
  - likely supported entity type(s): hash, ip_address
