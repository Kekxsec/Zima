---
title: "prompt / threat_intel / pulsedive"
aliases: ["pulsedive", "pulsedive prompt", "pulsedive research prompt"]
tags: [zima, research, prompts, provider-research, threat_intel, pulsedive, graph_exclude]
...
- Provider name: pulsedive
- Provider category: threat_intel
- Provider website / API docs URL: https://pulsedive.com/api/
- Target module(s) from my provider map: malware_ioc_monitor, threat_actor_mentions
- Build priority / tier: 3 / Pro
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): lookup(ip, domain, url)
  - likely provider-side category label(s): threat_intel
  - likely supported entity type(s): ip_address, domain, url
