---
title: "prompt / threat_intel / hybrid_analysis"
aliases: ["hybrid_analysis", "hybrid_analysis prompt", "hybrid_analysis research prompt"]
tags: [zima, research, prompts, provider-research, threat_intel, hybrid_analysis, graph_exclude]
...
- Provider website / API docs URL: https://www.hybrid-analysis.com/docs/api/v2
...
- Schema hints already captured in my notes:
  - likely provider method(s): lookup(hash)
  - likely provider-side category label(s): malware_detection
  - likely supported entity type(s): hash
