---
title: "prompt / threat_intel / abusech"
aliases: ["abusech", "abusech prompt", "abusech research prompt"]
tags: [zima, research, prompts, provider-research, threat_intel, abusech, graph_exclude]
...
- Provider name: abusech
- Provider category: threat_intel
- Provider website / API docs URL: https://abuse.ch/
- Target module(s) from my provider map: malware_ioc_monitor, emerging_threats
- Build priority / tier: 3 / Pro
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): lookup(domain, ip, hash)
