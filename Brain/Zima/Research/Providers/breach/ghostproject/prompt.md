---
title: "prompt / breach / ghostproject"
aliases: ["ghostproject", "ghostproject prompt", "ghostproject research prompt"]
tags: [zima, research, prompts, provider-research, breach, ghostproject, graph_exclude]
...
- Provider name: ghostproject
- Provider category: breach
- Provider website / API docs URL: https://ghostproject.fr/
...
- If there is no stable public API documentation, treat this provider as documentation-poor and be strict about evidence labels.
- Confirm whether it is a direct query service over breach datasets or only a portal; that changes implementation viability.
- Look specifically for breach source, password presence, and recency fields before assigning high or critical severity.
