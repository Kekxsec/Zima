---
title: "prompt / breach / illicit_services"
aliases: ["illicit_services", "illicit_services prompt", "illicit_services research prompt"]
tags: [zima, research, prompts, provider-research, breach, illicit_services, graph_exclude]
...
- Provider name: illicit_services
- Provider category: breach
- Provider website / API docs URL: unknown - please search official site/docs
...
- Official documentation may be limited or absent. If the product is primarily operational rather than developer-facing, document that gap explicitly.
- Focus on whether the service returns concrete exposed credentials, actor references, service/source names, or only search metadata.
- Do not over-claim confidence when the collection method is opaque.
