---
title: "prompt / breach / snusbase"
aliases: ["snusbase", "snusbase prompt", "snusbase research prompt"]
tags: [zima, research, prompts, provider-research, breach, snusbase, graph_exclude]
...
- Provider name: snusbase
- Provider category: breach
- Provider website / API docs URL: https://snusbase.com/
...
- If official schema docs are sparse, prioritize first-party examples and clearly mark everything else as inferred.
- Determine whether results include raw credential material, source dataset metadata, or only existence checks.
- Treat any password/plaintext field as potentially critical only if the docs/examples clearly support that interpretation.
