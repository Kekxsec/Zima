---
title: "prompt / breach / leakcheck"
aliases: ["leakcheck", "leakcheck prompt", "leakcheck research prompt"]
tags: [zima, research, prompts, provider-research, breach, leakcheck, graph_exclude]
...
- Provider name: leakcheck
- Provider category: breach
- Provider website / API docs URL: https://leakcheck.io/
- Target module(s) from my provider map: credential_exposure
...
- Verify whether official API docs are public or gated behind account access. If only marketing/site docs are public, label schema-level claims carefully.
- Prioritize identifying fields that indicate plaintext password, hash only, source breach, stealer provenance, or simple hit/no-hit results.
- Do not assume all leak results are equal; freshness and credential specificity should drive confidence and severity.
