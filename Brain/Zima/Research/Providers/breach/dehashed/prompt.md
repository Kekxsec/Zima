---
title: "prompt / breach / dehashed"
aliases: ["dehashed", "dehashed prompt", "dehashed research prompt"]
tags: [zima, research, prompts, provider-research, breach, dehashed, graph_exclude]
...
- Provider name: dehashed
- Provider category: breach
- Provider website / API docs URL: https://www.dehashed.com/
...
- Schema hints already captured in my notes:
  - likely provider method(s): search_breaches(email, domain)
...
- Check whether the current official product still offers searchable breach data and whether the API is public, partner-only, or undocumented.
- Pay close attention to credential material fields such as password, hashed_password, database_name, and record source, because they may split high vs critical severity.
- Separate asset-discovery/enrichment endpoints from direct exposure findings.
