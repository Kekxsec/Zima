---
title: "prompt / breach / psbdmp"
aliases: ["psbdmp", "psbdmp prompt", "psbdmp research prompt"]
tags: [zima, research, prompts, provider-research, breach, psbdmp, graph_exclude]
...
- Treat public examples and project-maintained wrappers cautiously unless you can locate a clear first-party interface or schema description.
- Differentiate paste-index hits from direct credential compromise.
- Implementation may be brittle if the service is unofficial or unstable; call that out.
