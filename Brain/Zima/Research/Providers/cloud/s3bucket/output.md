---
title: "output / cloud / s3bucket"
aliases: ["s3bucket output", "s3bucket signal registry"]
tags: [zima, research, outputs, signal-registry, cloud, s3bucket, graph_exclude]
type: provider_research_output
provider: s3bucket
provider_category: cloud
status: not_started
prompt_note: prompt.md
provider_folder: s3bucket.md
