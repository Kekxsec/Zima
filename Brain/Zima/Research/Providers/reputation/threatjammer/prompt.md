---
title: "prompt / reputation / threatjammer"
aliases: ["threatjammer", "threatjammer prompt", "threatjammer research prompt"]
tags: [zima, research, prompts, provider-research, reputation, threatjammer, graph_exclude]
type: provider_research_prompt
provider: threatjammer
...
- Schema hints already captured in my notes:
  - likely provider method(s): check(ip)
  - likely provider-side category label(s): ip_reputation
  - likely supported entity type(s): ip_address
  - rough provider confidence note from my research scaffold: 0.75-0.85
...
- Likely reason: not every reputation hit should map above medium without stronger evidence.
- Status: verify whether scores, reasons, or list types justify severity changes.
