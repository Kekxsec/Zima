---
title: "prompt / reputation / greynoise"
aliases: ["greynoise", "greynoise prompt", "greynoise research prompt"]
tags: [zima, research, prompts, provider-research, reputation, greynoise, graph_exclude]
...
- Provider name: greynoise
- Provider category: reputation
- Provider website / API docs URL: https://docs.greynoise.io/
...
- Likely reason: benign internet background noise should not map to the same severity as confirmed malicious classifications.
- Status: verify how the API distinguishes benign / unknown / malicious / noise / riot classifications.
