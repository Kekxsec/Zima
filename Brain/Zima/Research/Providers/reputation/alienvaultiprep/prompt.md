---
title: "prompt / reputation / alienvaultiprep"
aliases: ["alienvaultiprep", "alienvaultiprep prompt", "alienvaultiprep research prompt"]
tags: [zima, research, prompts, provider-research, reputation, alienvaultiprep, graph_exclude]
type: provider_research_prompt
provider: alienvaultiprep
...
- Schema hints already captured in my notes:
  - likely provider method(s): get_reputation(ip, domain)
  - likely provider-side category label(s): threat_intel
  - likely supported entity type(s): ip_address, domain
