---
title: "prompt / domain / certspotter"
aliases: ["certspotter", "certspotter prompt", "certspotter research prompt"]
tags: [zima, research, prompts, provider-research, domain, certspotter, graph_exclude]
...
- Provider name: certspotter
- Provider category: domain
- Provider website / API docs URL: https://sslmate.com/help/reference/ct_search_api_v1
- Target module(s) from my provider map: certificate_monitor
- Build priority / tier: 3 / Pro
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): monitor(domain)
  - likely provider-side category label(s): tls_certificate
