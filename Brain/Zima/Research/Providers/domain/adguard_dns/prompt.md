---
title: "prompt / domain / adguard_dns"
aliases: ["adguard_dns", "adguard_dns prompt", "adguard_dns research prompt"]
tags: [zima, research, prompts, provider-research, domain, adguard_dns, graph_exclude]
type: provider_research_prompt
provider: adguard_dns
...
- Provider name: adguard_dns
- Provider category: domain
- Provider website / API docs URL: unknown - please search
- Target module(s) from my provider map: dns_security, phishing_feed_monitor
- Build priority / tier: 3 / Pro
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): resolve(domain)
  - likely provider-side category label(s): dns_record, blocklist_hit
  - likely supported entity type(s): domain
  - rough provider confidence note from my research scaffold: 0.90-0.95
