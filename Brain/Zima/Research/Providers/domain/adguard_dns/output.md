---
title: "output / domain / adguard_dns"
aliases: ["adguard_dns output", "adguard_dns signal registry"]
tags: [zima, research, outputs, signal-registry, domain, adguard_dns, graph_exclude]
type: provider_research_output
provider: adguard_dns
provider_category: domain
status: not_started
prompt_note: prompt.md
provider_folder: adguard_dns.md
