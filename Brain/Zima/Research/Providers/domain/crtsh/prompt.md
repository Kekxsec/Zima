---
title: "prompt / domain / crtsh"
aliases: ["crtsh", "crtsh prompt", "crtsh research prompt"]
tags: [zima, research, prompts, provider-research, domain, crtsh, graph_exclude]
...
- Provider website / API docs URL: https://crt.sh/
- Target module(s) from my provider map: certificate_monitor, subdomain_enumeration
...
- Schema hints already captured in my notes:
  ...
  - likely supported entity type(s): domain, hostname
