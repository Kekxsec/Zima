---
title: "prompt / domain / jsonwhoiscom"
aliases: ["jsonwhoiscom", "jsonwhoiscom prompt", "jsonwhoiscom research prompt"]
tags: [zima, research, prompts, provider-research, domain, jsonwhoiscom, graph_exclude]
type: provider_research_prompt
provider: jsonwhoiscom
...
- Provider name: jsonwhoiscom
- Provider category: domain
- Provider website / API docs URL: unknown - please search
- Target module(s) from my provider map: dns_security, domain_reputation
- Build priority / tier: 3 / Pro
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): lookup(domain)
  - likely provider-side category label(s): domain_ownership
  - likely supported entity type(s): domain, email
  - rough provider confidence note from my research scaffold: 0.85-0.90
