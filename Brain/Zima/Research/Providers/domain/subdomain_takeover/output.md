---
title: "output / domain / subdomain_takeover"
aliases: ["subdomain_takeover output", "subdomain_takeover signal registry"]
tags: [zima, research, outputs, signal-registry, domain, subdomain_takeover, graph_exclude]
type: provider_research_output
provider: subdomain_takeover
provider_category: domain
status: not_started
prompt_note: prompt.md
provider_folder: subdomain_takeover.md
