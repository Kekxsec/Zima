---
title: "prompt / social / github"
aliases: ["github", "github prompt", "github research prompt"]
tags: [zima, research, prompts, provider-research, social, github, graph_exclude]
...
- Provider website / API docs URL: https://docs.github.com/en/rest
- Target module(s) from my provider map: github_secret_scan, public_profile_scan
- Build priority / tier: 3 / Pro
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): search_profiles(domain, email, username)
