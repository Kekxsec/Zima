---
title: "prompt / social / opencorporates"
aliases: ["opencorporates", "opencorporates prompt", "opencorporates research prompt"]
tags: [zima, research, prompts, provider-research, social, opencorporates, graph_exclude]
...
- Target module(s) from my provider map: public_profile_scan, data_broker_exposure
- Build priority / tier: 2 / Plus
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): search(name, domain)
  - likely provider-side category label(s): corporate_registration
  - likely supported entity type(s): domain, company
