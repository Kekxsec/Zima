---
title: "prompt / social / stackoverflow"
aliases: ["stackoverflow", "stackoverflow prompt", "stackoverflow research prompt"]
tags: [zima, research, prompts, provider-research, social, stackoverflow, graph_exclude]
...
- Schema hints already captured in my notes:
  - likely provider method(s): lookup(username, email)
  - likely provider-side category label(s): social_media
