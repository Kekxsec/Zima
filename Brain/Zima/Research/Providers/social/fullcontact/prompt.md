---
title: "prompt / social / fullcontact"
aliases: ["fullcontact", "fullcontact prompt", "fullcontact research prompt"]
tags: [zima, research, prompts, provider-research, social, fullcontact, graph_exclude]
...
- Provider name: fullcontact
- Provider category: social
- Provider website / API docs URL: unknown - please search
- Target module(s) from my provider map: public_profile_scan
- Build priority / tier: 2 / Plus
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): enrich(email, domain)
  - likely provider-side category label(s): identity_exposure
