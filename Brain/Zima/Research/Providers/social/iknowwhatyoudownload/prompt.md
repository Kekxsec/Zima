---
title: "prompt / social / iknowwhatyoudownload"
aliases: ["iknowwhatyoudownload", "iknowwhatyoudownload prompt", "iknowwhatyoudownload research prompt"]
tags: [zima, research, prompts, provider-research, social, iknowwhatyoudownload, graph_exclude]
type: provider_research_prompt
provider: iknowwhatyoudownload
...
- Provider name: iknowwhatyoudownload
- Provider category: social
- Provider website / API docs URL: unknown - please search
- Target module(s) from my provider map: people_search_exposure
...
- Schema hints already captured in my notes:
  ...
  - likely provider-side category label(s): privacy_exposure
