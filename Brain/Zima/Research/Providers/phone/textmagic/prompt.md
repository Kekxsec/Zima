---
title: "prompt / phone / textmagic"
aliases: ["textmagic", "textmagic prompt", "textmagic research prompt"]
tags: [zima, research, prompts, provider-research, phone, textmagic, graph_exclude]
...
- Provider name: textmagic
- Provider category: phone
- Provider website / API docs URL: unknown - please search
- Target module(s) from my provider map: alerts_only_not_scan_provider
- Build priority / tier: 2 / Plus
- Provider role: non_scan_alerting
...
- Your provider map marks this as alerts-only, not a scan provider. Confirm whether it belongs in the signal registry at all.
