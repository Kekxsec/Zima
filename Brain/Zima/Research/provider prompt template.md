---
title: "provider prompt template"
tags: [zima, research, prompts, template, graph_exclude]
type: provider_research_prompt_template
obsidianUIMode: preview
---

[[research|Research]] · [[provider-research-protocol|Provider Research Protocol]]

# Provider Prompt Template

Use this only when creating or upgrading a provider-specific `prompt.md`.

For day-to-day execution, work from:
...
- Provider website / API docs URL: [URL if known, otherwise "unknown - please search"]
- Target module(s) from my provider map: [MODULES]
- Build priority / tier: [PRIORITY] / [TIER]
- Provider role: [signal_producer / utility_enrichment / local_tool_or_deferred / non_scan_alerting]
- Schema hints already captured in my notes:
  - likely provider method(s): [METHODS]
  - likely provider-side category label(s): [SCHEMA CATEGORY LABELS]
  - likely supported entity type(s): [ENTITY TYPES]
  - rough provider confidence note from my research scaffold: [ROUGH PROVIDER CONFIDENCE]
- Important provider-specific cautions:
- [PROVIDER-SPECIFIC CAUTIONS]
- My first-pass severity assessment:
- [Paste stripped internal note lines here]
