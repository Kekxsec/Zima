...
|---|---|---|
| [[../Research/Providers/tools/lynis/lynis|lynis]] | host hardening evidence | `os_security`, `firewall_status` |
| [[../Research/Providers/tools/trivy/trivy|trivy]] | software vulnerability evidence | `software_vulnerability` |
| [[../Research/Providers/tools/grype/grype|grype]] | software vulnerability evidence | `software_vulnerability` |
| [[../Research/Providers/tools/syft/syft|syft]] | inventory and SBOM support | `software_inventory` |

## Browser Configuration and Enrichment

| provider | role | target modules |
|---|---|---|
| [[../Research/Providers/tools/chromium_enterprise_policies/chromium_enterprise_policies|chromium_enterprise_policies]] | browser policy evidence | `browser_configuration` |
| [[../Research/Providers/tools/firefox_enterprise_policies/firefox_enterprise_policies|firefox_enterprise_policies]] | browser policy evidence | `browser_configuration` |
| [[../Research/Providers/threat_intel/crxcavator/crxcavator|crxcavator]] | extension risk enrichment | `extension_risk` |

## Identity and Privacy Enrichment

| provider | role | target modules |
|---|---|---|
| [[../Research/Providers/social/emailformat/emailformat|emailformat]] | alias support | `alias_correlation` |
| [[../Research/Providers/social/gravatar/gravatar|gravatar]] | public profile enrichment | `public_profile_scan` |
| [[../Research/Providers/social/skymem/skymem|skymem]] | public email exposure support | `username_exposure` |
| [[../Research/Providers/social/emailcrawlr/emailcrawlr|emailcrawlr]] | public email mention support | `username_exposure` |
...
| provider | role | target modules |
|---|---|---|
| `simplelogin` | per-service alias creation and management | `alias_management` |
| `addy.io` | per-service alias creation and management | `alias_management` |
