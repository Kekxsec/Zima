---
title: "prompt / darkweb / ahmia"
aliases: ["ahmia", "ahmia prompt", "ahmia research prompt"]
tags: [zima, research, prompts, provider-research, darkweb, ahmia, graph_exclude]
...
- Schema hints already captured in my notes:
  - likely provider method(s): search_darkweb(domain, email, username)
  - likely provider-side category label(s): identity_exposure
  - likely supported entity type(s): url
  - rough provider confidence note from my research scaffold: 0.65
