---
title: "prompt / darkweb / onionsearchengine"
aliases: ["onionsearchengine", "onionsearchengine prompt", "onionsearchengine research prompt"]
tags: [zima, research, prompts, provider-research, darkweb, onionsearchengine, graph_exclude]
type: provider_research_prompt
provider: onionsearchengine
...
- Provider name: onionsearchengine
- Provider category: darkweb
- Provider website / API docs URL: unknown - please search
- Target module(s) from my provider map: darkweb_identity_monitor
- Build priority / tier: 2 / Plus
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): search(query)
  - likely provider-side category label(s): darkweb_mention
  - likely supported entity type(s): url
  - rough provider confidence note from my research scaffold: 0.60-0.65
