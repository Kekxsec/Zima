---
title: "prompt / breach / pastebin"
aliases: ["pastebin", "pastebin prompt", "pastebin research prompt"]
tags: [zima, research, prompts, provider-research, breach, pastebin, graph_exclude]
...
- Provider name: pastebin
- Provider category: breach
- Provider website / API docs URL: https://pastebin.com/doc_api
- Target module(s) from my provider map: alias_correlation, breach_monitor
...
- Schema hints already captured in my notes:
  ...
  - likely provider-side category label(s): paste_mention
  - likely supported entity type(s): email, domain
  - rough provider confidence note from my research scaffold: 0.65-0.75
- Important provider-specific cautions:
- Pastebin has official API docs, but many endpoints are publishing/account workflows rather than search/intelligence endpoints. Keep only search-relevant capabilities in scope.
- A paste mention is not automatically a breach. Separate alias correlation, weak mentions, and clearly exposed credentials.
- Source persistence and paste deletion can affect freshness and confidence; note that in the output.
