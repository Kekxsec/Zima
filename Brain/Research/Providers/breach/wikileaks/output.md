...
- **Endpoint / artifact**
    ...
    - Example: `https://our.wikileaks.org/api.php?action=ask&query=%5B%5BModification+date%3A%3A%2B%5D%5D|limit=5|offset=1`. [our.wikileaks](https://our.wikileaks.org/api.php?action=ask&query=%5B%5BModification+date%3A%3A%2B%5D%5D%7Climit%3D5%7Coffset%3D1)
