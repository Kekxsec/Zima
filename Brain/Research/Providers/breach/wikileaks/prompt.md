---
title: "prompt / breach / wikileaks"
aliases: ["wikileaks", "wikileaks prompt", "wikileaks research prompt"]
tags: [zima, research, prompts, provider-research, breach, wikileaks, graph_exclude]
...
- Provider name: wikileaks
- Provider category: breach
- Provider website / API docs URL: https://wikileaks.org/
...
- Schema hints already captured in my notes:
  ...
  - rough provider confidence note from my research scaffold: 0.75
- Important provider-specific cautions:
- This may function more like a searchable corpus than a structured breach API. Confirm whether any machine-readable endpoint exists before investing in a full registry.
- Most findings may be mention-level or document-level exposure rather than direct credential proof.
- If the provider lacks stable API semantics, prefer a minimal mapping with explicit uncertainty.
