---
title: "prompt / breach / citadel"
aliases: ["citadel", "citadel prompt", "citadel research prompt"]
tags: [zima, research, prompts, provider-research, breach, citadel, graph_exclude]
...
- Clarify whether this provider is a real standalone API/data source in your target stack or a placeholder inherited from SpiderFoot-era mapping.
- If official docs cannot be found, record that implementation risk explicitly rather than forcing a detailed registry.
- Only map signal types supported by primary evidence.
