---
title: "prompt / domain / dnszonexfer"
aliases: ["dnszonexfer", "dnszonexfer prompt", "dnszonexfer research prompt"]
tags: [zima, research, prompts, provider-research, domain, dnszonexfer, graph_exclude]
type: provider_research_prompt
provider: dnszonexfer
...
- Provider name: dnszonexfer
- Provider category: domain
- Provider website / API docs URL: unknown - please search
- Target module(s) from my provider map: dns_security
- Build priority / tier: 3 / Pro
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): attempt(domain)
  - likely provider-side category label(s): dns_misconfiguration
