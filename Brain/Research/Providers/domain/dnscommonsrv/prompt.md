---
title: "prompt / domain / dnscommonsrv"
aliases: ["dnscommonsrv", "dnscommonsrv prompt", "dnscommonsrv research prompt"]
tags: [zima, research, prompts, provider-research, domain, dnscommonsrv, graph_exclude]
type: provider_research_prompt
provider: dnscommonsrv
...
- Schema hints already captured in my notes:
  - likely provider method(s): enumerate(domain)
  - likely provider-side category label(s): subdomain_discovery
  - likely supported entity type(s): hostname
  - rough provider confidence note from my research scaffold: 0.65-0.80
