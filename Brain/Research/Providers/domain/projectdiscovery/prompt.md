---
title: "prompt / domain / projectdiscovery"
aliases: ["projectdiscovery", "projectdiscovery prompt", "projectdiscovery research prompt"]
tags: [zima, research, prompts, provider-research, domain, projectdiscovery, graph_exclude]
...
- Provider name: projectdiscovery
...
- Schema hints already captured in my notes:
  - likely provider method(s): search(domain)
  - likely provider-side category label(s): subdomain_discovery
  - likely supported entity type(s): hostname
  - rough provider confidence note from my research scaffold: 0.70-0.80
