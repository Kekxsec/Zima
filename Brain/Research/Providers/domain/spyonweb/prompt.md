---
title: "prompt / domain / spyonweb"
aliases: ["spyonweb", "spyonweb prompt", "spyonweb research prompt"]
tags: [zima, research, prompts, provider-research, domain, spyonweb, graph_exclude]
...
- Provider name: spyonweb
- Provider category: domain
- Provider website / API docs URL: unknown - please search
- Target module(s) from my provider map: subdomain_enumeration, dns_security
- Build priority / tier: 3 / Pro
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): lookup(domain, ip)
  - likely provider-side category label(s): domain_ownership, host_discovery
