---
title: "prompt / domain / securitytrails"
aliases: ["securitytrails", "securitytrails prompt", "securitytrails research prompt"]
tags: [zima, research, prompts, provider-research, domain, securitytrails, graph_exclude]
...
- Provider name: securitytrails
- Provider category: domain
- Provider website / API docs URL: https://docs.securitytrails.com/docs/overview
- Target module(s) from my provider map: dns_security, subdomain_enumeration, certificate_monitor
- Build priority / tier: 3 / Pro
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): lookup_domain(domain, email, ip)
  - likely provider-side category label(s): domain_security, dns_record
  - likely supported entity type(s): hostname, domain
  - rough provider confidence note from my research scaffold: 0.70-0.85
