---
title: "prompt / domain / subdomain_takeover"
aliases: ["subdomain_takeover", "subdomain_takeover prompt", "subdomain_takeover research prompt"]
tags: [zima, research, prompts, provider-research, domain, subdomain_takeover, graph_exclude]
type: provider_research_prompt
provider: subdomain_takeover
...
- Provider name: subdomain_takeover
- Provider category: domain
- Provider website / API docs URL: unknown - please search
- Target module(s) from my provider map: subdomain_enumeration
- Build priority / tier: 3 / Pro
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): check(hostname)
  - likely provider-side category label(s): subdomain_takeover
  - likely supported entity type(s): hostname
