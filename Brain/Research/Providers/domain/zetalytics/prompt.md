---
title: "prompt / domain / zetalytics"
aliases: ["zetalytics", "zetalytics prompt", "zetalytics research prompt"]
tags: [zima, research, prompts, provider-research, domain, zetalytics, graph_exclude]
...
- Provider name: zetalytics
- Provider category: domain
- Provider website / API docs URL: unknown - please search
- Target module(s) from my provider map: domain_reputation, domain_ioc_match
...
- Schema hints already captured in my notes:
  ...
  - likely provider-side category label(s): domain_reputation
