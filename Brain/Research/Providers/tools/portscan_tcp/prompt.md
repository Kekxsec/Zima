---
title: "prompt / tools / portscan_tcp"
aliases: ["portscan_tcp", "portscan_tcp prompt", "portscan_tcp research prompt"]
tags: [zima, research, prompts, provider-research, tools, portscan_tcp, graph_exclude]
type: provider_research_prompt
provider: portscan_tcp
...
- Provider name: portscan_tcp
- Provider category: tools
- Provider website / API docs URL: unknown - please search
- Target module(s) from my provider map: infrastructure
...
- This is a local-binary/tooling provider in your notes, not a pure SaaS API. Confirm whether there is any machine-readable output schema worth mapping before spending time on it.
