---
title: "prompt / threat_intel / crxcavator"
aliases: ["crxcavator", "crxcavator prompt", "crxcavator research prompt"]
tags: [zima, research, prompts, provider-research, threat_intel, crxcavator, graph_exclude]
...
- Schema hints already captured in my notes:
  - likely provider method(s): check(extension_id)
  - likely provider-side category label(s): browser_extension_risk
  - likely supported entity type(s): extension_id
