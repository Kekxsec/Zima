---
title: "prompt / threat_intel / googlesafebrowsing"
aliases: ["googlesafebrowsing", "googlesafebrowsing prompt", "googlesafebrowsing research prompt"]
tags: [zima, research, prompts, provider-research, threat_intel, googlesafebrowsing, graph_exclude]
...
- Provider name: googlesafebrowsing
- Provider category: threat_intel
- Provider website / API docs URL: https://developers.google.com/safe-browsing/reference/rest
...
- Schema hints already captured in my notes:
  - likely provider method(s): check(url)
  - likely provider-side category label(s): phishing, malware_detection
  - likely supported entity type(s): url
  - rough provider confidence note from my research scaffold: 0.95
