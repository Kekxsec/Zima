---
title: "prompt / threat_intel / talosintel"
aliases: ["talosintel", "talosintel prompt", "talosintel research prompt"]
tags: [zima, research, prompts, provider-research, threat_intel, talosintel, graph_exclude]
...
- Provider name: talosintel
- Provider category: threat_intel
- Provider website / API docs URL: https://talosintelligence.com/
...
- Schema hints already captured in my notes:
  - likely provider method(s): check(ip, domain)
  - likely provider-side category label(s): ip_reputation, domain_reputation
