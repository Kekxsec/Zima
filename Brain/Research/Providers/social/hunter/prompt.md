---
title: "prompt / social / hunter"
aliases: ["hunter", "hunter prompt", "hunter research prompt"]
tags: [zima, research, prompts, provider-research, social, hunter, graph_exclude]
...
- Provider website / API docs URL: https://hunter.io/api-documentation
- Target module(s) from my provider map: email_extractor, username_exposure
- Build priority / tier: 2 / Plus
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): find(domain)
  - likely provider-side category label(s): email_discovery
