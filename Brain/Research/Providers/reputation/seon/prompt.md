---
title: "prompt / reputation / seon"
aliases: ["seon", "seon prompt", "seon research prompt"]
tags: [zima, research, prompts, provider-research, reputation, seon, graph_exclude]
...
- Target module(s) from my provider map: identity_widely_exposed
- Build priority / tier: 2 / Plus
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): check(email)
