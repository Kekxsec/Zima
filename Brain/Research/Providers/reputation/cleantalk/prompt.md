---
title: "prompt / reputation / cleantalk"
aliases: ["cleantalk", "cleantalk prompt", "cleantalk research prompt"]
tags: [zima, research, prompts, provider-research, reputation, cleantalk, graph_exclude]
...
- Provider name: cleantalk
- Provider category: reputation
- Provider website / API docs URL: unknown - please search
- Target module(s) from my provider map: account_enumeration_risk
- Build priority / tier: 2 / Plus
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): check(ip, email)
  - likely provider-side category label(s): spam_detection
