---
title: "prompt / reputation / ipqualityscore"
aliases: ["ipqualityscore", "ipqualityscore prompt", "ipqualityscore research prompt"]
tags: [zima, research, prompts, provider-research, reputation, ipqualityscore, graph_exclude]
...
- Provider name: ipqualityscore
- Provider category: reputation
- Provider website / API docs URL: https://www.ipqualityscore.com/documentation/overview
- Target module(s) from my provider map: domain_reputation, phishing_feed_monitor
- Build priority / tier: 2 / Plus
- Provider role: signal_producer
- Schema hints already captured in my notes:
  - likely provider method(s): get_score(ip, email)
  - likely provider-side category label(s): ip_reputation, email_reputation
  - likely supported entity type(s): ip_address, email
