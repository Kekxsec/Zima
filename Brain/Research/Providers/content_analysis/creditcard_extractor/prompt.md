---
title: "prompt / content_analysis / creditcard_extractor"
aliases: ["creditcard_extractor", "creditcard_extractor prompt", "creditcard_extractor research prompt"]
tags: [zima, research, prompts, provider-research, content_analysis, creditcard_extractor, graph_exclude]
type: provider_research_prompt
provider: creditcard_extractor
provider_category: content_analysis
...
- Provider name: creditcard_extractor
- Provider category: content_analysis
- Provider website / API docs URL: unknown - please search
- Target module(s) from my provider map: credential_dump_utility
- Build priority / tier: 4 / Business
- Provider role: utility_enrichment
- Schema hints already captured in my notes:
  - likely provider method(s): unknown
  - likely provider-side category label(s): unknown
  - likely supported entity type(s): unknown
...
- Your notes mark this as a utility provider used by other modules. Default assumption: extracted entities are enrichment unless the official docs clearly support direct signal generation.
