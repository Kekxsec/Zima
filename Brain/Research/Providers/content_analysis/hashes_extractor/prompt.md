---
title: "prompt / content_analysis / hashes_extractor"
aliases: ["hashes_extractor", "hashes_extractor prompt", "hashes_extractor research prompt"]
tags: [zima, research, prompts, provider-research, content_analysis, hashes_extractor, graph_exclude]
type: provider_research_prompt
provider: hashes_extractor
...
- Provider name: hashes_extractor
- Provider category: content_analysis
- Provider website / API docs URL: unknown - please search
- Target module(s) from my provider map: malware_ioc_monitor_utility
