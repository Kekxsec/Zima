---
title: "prompt / ip / bgpview"
aliases: ["bgpview", "bgpview prompt", "bgpview research prompt"]
tags: [zima, research, prompts, provider-research, ip, bgpview, graph_exclude]
...
- Provider name: bgpview
- Provider category: ip
- Provider website / API docs URL: unknown - please search
- Target module(s) from my provider map: exposed_services
...
- Schema hints already captured in my notes:
  ...
  - likely provider-side category label(s): network_ownership
  - likely supported entity type(s): ip_address, asn
