---
title: "prompt / ip / binaryedge"
aliases: ["binaryedge", "binaryedge prompt", "binaryedge research prompt"]
tags: [zima, research, prompts, provider-research, ip, binaryedge, graph_exclude]
...
- Provider name: binaryedge
- Provider category: ip
- Provider website / API docs URL: https://docs.binaryedge.io/api-v2.html
...
- Schema hints already captured in my notes:
  - likely provider method(s): scan(ip, domain)
  - likely provider-side category label(s): port_discovery, vulnerability
